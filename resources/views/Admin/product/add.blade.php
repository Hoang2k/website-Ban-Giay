      ...
      <section class="panel">
        ...
        {{ csrf_field() }}
            <div class="form-group">
                ...
                <input type="text" id="name" value="{{old('name')}}" name="name" class="form-control" placeholder="Nhập tên sản phẩm">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number"  value="{{old('price')}}" id="price" name="price" class="form-control" placeholder="Nhập giá sản phẩm">
            </div>
            <div class="form-group">
                <label for="" >Giá khuyến mại  <span class="text-danger">(*)</span></label>
                <input type="number" id="price_sale" name="price_sale" class="form-control" placeholder="Nhập giá khuyến mại">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               ...
               <textarea  id="content"name="description"  rows="6" class="form-control"></textarea>
            </div>
            <div class="form-group">
